 ...
 */
public class DragLayoutByUmano extends LinearLayout{
    private static final String TAG = DragLayoutByUmano.class.getSimpleName();
    ...
    public DragLayoutByUmano(Context context) {
        this(context, null);
    }

    public DragLayoutByUmano(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragLayoutByUmano(Context context, AttributeSet attrs, int defStyle) {
